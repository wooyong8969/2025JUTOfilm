...
class FrameSelectWindow_1(BaseWindow):
    """
    4컷 프레임 선택 화면
    """
    def __init__(self):
        ...
        self.move_select_2.clicked.connect(self.on_select_2)
...
class FrameSelectWindow_2(BaseWindow):
    """
    4컷 프레임 선택 화면
    """
    def __init__(self):
        ...
        self.move_previous.clicked.connect(self.on_prev)
        self.move_next.clicked.connect(self.on_next)
        self.move_select_1.clicked.connect(self.on_select_1)
