...
class MainWindow(BaseWindow):
    ...
    def __init__(self):
        super().__init__()
        uic.loadUi("./page_ui_2025/main.ui", self)
...
class ExplainWindow(BaseWindow):
    ...
    def __init__(self):
        super().__init__()
        uic.loadUi("./page_ui_2025/explain.ui", self)
...
class NumSelectWindow(BaseWindow):
    ...
    def __init__(self):
        super().__init__()
        uic.loadUi("./page_ui_2025/num_select.ui", self)

        self.max_num = 4
        state.print_num = 1

        self.label_plus.setPixmap(QPixmap('./pages_img_2025/print_num/plus.png'))
    ...
    def on_plus(self):
        if state.print_num < self.max_num:
            ...
            self.label.setPixmap(QPixmap(f'./count/{state.print_num}.png'))
            self.label_plus.setPixmap(QPixmap('./pages_img_2025/print_num/plus.png'))
            self.label_minus.setPixmap(QPixmap('./pages_img_2025/print_num/minus.png'))
